              ...
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) =>
                            ElectPayment(image: "assets/abuja.jpg", id: 3)));
              },
              child: Card(
                elevation: 10,
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) =>
                            ElectPayment(image: "assets/ikeja.jpg", id: 1)));
              },
              child: Card(
                elevation: 10,
                margin: EdgeInsets.fromLTRB(10, 10, 10, 0),
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) =>
                            ElectPayment(image: "assets/enugu.jpeg", id: 5)));
              },
              child: Card(
                elevation: 10,
                margin: EdgeInsets.fromLTRB(10, 10, 10, 0),
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) =>
                            ElectPayment(image: "assets/kaduna.jpg", id: 8)));
              },
              child: Card(
                elevation: 10,
                margin: EdgeInsets.fromLTRB(10, 10, 10, 0),
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) =>
                            ElectPayment(image: "assets/ibadan.png", id: 7)));
              },
              child: Card(
                elevation: 10,
                margin: EdgeInsets.fromLTRB(10, 10, 10, 0),
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) =>
                            ElectPayment(image: "assets/benin.jpeg", id: 10)));
              },
              child: Card(
                elevation: 10,
                margin: EdgeInsets.fromLTRB(10, 10, 10, 0),
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (context) =>
                            ElectPayment(image: "assets/yola.jpg", id: 11)));
              },
              child: Card(
                elevation: 10,
                margin: EdgeInsets.fromLTRB(10, 10, 10, 0),
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        CircleAvatar(
                          backgroundImage: AssetImage("assets/porthacout.jpg"),
                          radius: 20.0,
                        ),
                        SizedBox(width: 20),
                        Text(
